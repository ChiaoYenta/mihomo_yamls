...
| 文件名 | 大小 | 链接 |
| :--- | :--- | :--- |
| `configfull.yaml` | 33.9 KB | [查看](https://github.com/MARSCHIAO/mihomo_yamls/blob/main/General_Config/Lanlan13-14/configfull.yaml) |
| `configfull_NoAd.yaml` | 33.5 KB | [查看](https://github.com/MARSCHIAO/mihomo_yamls/blob/main/General_Config/Lanlan13-14/configfull_NoAd.yaml) |
| `configfull_lite.yaml` | 17.5 KB | [查看](https://github.com/MARSCHIAO/mihomo_yamls/blob/main/General_Config/Lanlan13-14/configfull_lite.yaml) |